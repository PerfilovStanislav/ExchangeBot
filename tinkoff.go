...
func (tinkoff *Tinkoff) init() {
	//
}

func (tinkoff *Tinkoff) listenCandles(operations []OperationParameter) {
	//
}
...
func (tinkoff *Tinkoff) downloadCandles(candleData *CandleData, param OperationParameter) {
